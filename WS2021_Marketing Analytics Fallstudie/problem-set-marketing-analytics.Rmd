...
Wie sieht der Datensatz mit horsepower 98 und mpg 22 aus?
```{r}
...
Wir können aus den Daten schlussfolgern, dass das BDT näher am tatsächlichen Ergebnis dran ist.
...
Threshold = 0.4
```{r}
F1_Score(bt_threshold_40$threshold_40, gender_test$Gender)
```


Threshold = 0.5
```{r}
F1_Score(bt_threshold_50$threshold_50, gender_test$Gender)
```


Threshold = 0.7
```{r}
F1_Score(bt_threshold_70$threshold_70, gender_test$Gender)
```
...
Threshold = 0.4
```{r}
F1_Score(logreg_threshold_40$threshold_40, gender_test$Gender)
```


Threshold = 0.5
```{r}
F1_Score(logreg_threshold_50$threshold_50, gender_test$Gender)
```


Threshold = 0.7
```{r}
F1_Score(logreg_threshold_70$threshold_70, gender_test$Gender)
```
